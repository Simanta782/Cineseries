# Don't Remove Credit @VJ_otz
# Subscribe YouTube Channel For Amazing Bot @Tec_VJ
# Ask Doubt on telegram @KinVJ01
...
BOT_TOKEN = environ.get('BOT_TOKEN', "8113392400:AAEXQ9LEe_xKBjunzf6wpmBhLGaIiU65Fdw")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/6Jt.jpg https://envs.sh/6ou.jpg https://envs.sh/6ot.jpg https://envs.sh/6oi.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2115698950').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '@studu01').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002325269429'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002264005415').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002325269429')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jamessmithssp:jamessmithssp@cluster0.lemow.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/vj_t_disscussion')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/vj_bz')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'vj_botscussion') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/kinj01')
...
YEARS = ["1900", "1991", "1992", "1993", "1994", "1995", "1996", "1997", "1998", "1999", "2000", "2001", "2002", "2003", "2004", "2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025"]
                           ...
                           # Don't Remove Credit @VJ_Boz
                           # Subscribe YouTube Channel For Amazing Bot @Tec_VJ
                           # Ask Doubt on telegram @KinJ01
...
# Subscribe YouTube Channel For Amazing Bot @Tch_VJ
# Ask Doubt on telegram @KingJ01
